...
class FelxDataSet(object):
    ...
    def add_iron_model_params(self):
        ...
        params['k_org'] = 1e-04  # Organic iron scavenging rate constant [(nM Fe)^-0.58 day^-1] (Qin: 1.0521e-4, Galbraith: 4e-4)
        params['k_inorg'] = 6.1e-4  # Inorganic iron scavenging rate constant [(nM m Fe)^-0.5 day^-1] (Qin: 6.10e-4, Galbraith: 6e-4)
